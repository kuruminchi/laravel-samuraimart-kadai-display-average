      ...
      <form method="POST" action="{{ route('mypage') }}">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="name" class="text-md-left samuraimart-edit-user-info-label">
          </div>
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="email" class="text-md-left samuraimart-edit-user-info-label">
          </div>
          <div class="collapse show editUserName">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="postal_code" class="text-md-left samuraimart-edit-user-info-label">
          </div>
          <div class="collapse show editUserName">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="address" class="text-md-left samuraimart-edit-user-info-label">
          </div>
          <div class="collapse show editUserName">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between">
            <label for="phone" class="text-md-left samuraimart-edit-user-info-label">
          </div>
          <div class="collapse show editUserName">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <button type="button" class="close" data-bs-dismiss="modal" aria-label="閉じる">
                    <!-- メモ：aria-hidden="true"はcssによって非表示にされない限り表示する -->
                    <!-- メモ：&times; = × -->
