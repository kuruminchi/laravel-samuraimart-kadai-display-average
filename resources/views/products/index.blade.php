      ...
      <div class="row w-100">
        ...
        <div class="col-3">
          <a href="{{ route('products.show', $product) }}">
            <!-- もしproductsテーブルのimageカラムに値がnullでなければ -->
            @if ($product->image !== "")
            ...
            <div class="col-12">
              <p class="samuraimart-product-label mt-2 mb-0">
                ...
                <div class="d-flex align-items-center">
                  <div class="samuraimart-star-rating" data-rate="{{ round($product->averageRating() * 2) / 2 }}"></div>
                  <p class="mb-0 ms-2">{{ $product->averageRating() }}</p>
                </div>
